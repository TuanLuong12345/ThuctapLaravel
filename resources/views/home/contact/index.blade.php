...
<section class="section-contact-us" style="margin-top: 80px">
    ...
    <div class="container">
        <div class="home_menu">
            <a style="margin-left: 75px" href="{{route('home.index')}}" >{{ trans('messages.home') }}</a>
            <span>  /  </span>
            <a href="{{route('home.contacts')}}" >{{ trans('messages.contacts') }}</a>
        </div>
        <div class="contact_us row justify-content-center">
            <div class="col-md-9 text-center mb-5">
                <h2 style="margin-top: 40px;margin-bottom: 60px;margin-right: 50%;" class="heading-section">{{ trans('messages.contacts') }}</h2>
            </div>
        </div>
                ...
                <div class="wrapper">
                    <div class="row no-gutters mb-5">
                            ...
                            <div class="contact-wrap w-100 p-md-5 p-4">
                                ...
                                <form method="POST" action="{{route('home.contact_store')}}" id="contactForm" name="contactForm" class="contactForm">
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="margin-right: 15px;margin-left: 35px;" class="g-recaptcha" data-sitekey="6LfqYw4pAAAAABJtg7A9b78Hl_w4NRRmiSDfnW67"></div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input style="margin-right:50px;" type="submit" value="{{ trans('messages.contact_send') }}" class="btn btn-primary">
                        ...
                        <div class="col-md-4 d-flex align-items-stretch">
                            <div id="map">
                                <iframe style="margin-left: -100px;margin-top: -20px;"
